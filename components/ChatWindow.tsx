...
export function ChatWindow(props: {
  ...
  return (
    <div
      className={`flex flex-col items-center p-4 md:p-8 rounded-3xl bg-transparent grow overflow-hidden h-screen justify-center`}
    >
      <h2
        className={`${
          messages.length > 0 ? "" : "hidden"
        } text-4xl font-semibold font-sans text-neutral-100 p-5`}
      >
        {emoji} {titleText}
      </h2>
